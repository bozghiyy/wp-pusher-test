...
<div id="ad_branding"></div>

        <?php
      $code = do_shortcode('
                [notdevice]
                  <div style="display:none"  id="wrapping-div-gpt-ad-FEM_Branding_Desktop">
                    <div id="div-gpt-ad-FEM_Branding_Desktop" style="margin:0;padding:0;display:none;">
                    <script type="text/javascript">
                    googletag.cmd.push(function() { googletag.display("div-gpt-ad-FEM_Branding_Desktop"); });
                    </script>
                    </div>
                    </div>
                    <div style="display:none"  id="wrapping-div-gpt-ad-FEM_Branding_Overlayer">
                    <div id="div-gpt-ad-FEM_Overlayer_Desktop" style="margin:0;padding:0;display:none;">
                    <script type="text/javascript">
                    googletag.cmd.push(function() { googletag.display("div-gpt-ad-FEM_Overlayer_Desktop"); });
                    </script>
                    </div>
                    </div>              
                [/notdevice]              
